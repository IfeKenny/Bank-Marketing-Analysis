...
This bank marketing analysis report evaluates data from 11,000 customer contacts to understand deposit trends. Total deposits reached 5,000, with performance analyzed across key demographics and operational touchpoints, including marital status (married, divorced, single), age group (18-95), education level (primary, secondary, tertiary, unknown), communication channels (cellular, telephone, unknown), and various job categories. The following was analyzed 
- Analyze how education, job type, and marital status influence deposit outcomes.
...
- In the conversion rate by jobs, students and the retired contributes the highest to the deposit
